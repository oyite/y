...
var bodySilde = document.getElementById('imgContainer');
var currentItem = 3;
...
function slideImage(woodImage) {
  var imgItem = imgContainer[woodImage];
  img.src = imgItem.img;
...
var buttonbtn = document.getElementById('nav-list-button');
var ul = document.getElementById('list-ul'); // const ulList = document.getElementsByClassName('video-contents');
